...
const blogPosts = [
  {
    ...
    link: "/blog/smart-home-wiring-guide"
  },
  {
    id: 2,
    ...
    link: "/blog/electrical-safety-innovations"
  },
  {
    id: 3,
    ...
    link: "/blog/energy-efficient-lighting"
  }
];
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="border-t border-gray-200 pt-3 flex justify-between items-center font-semibold text-sm">
          <span className="bg-red-600 text-white px-3 py-1 rounded cursor-pointer
