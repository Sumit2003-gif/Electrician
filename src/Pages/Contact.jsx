  ...
  return (
    <div>
      <section
        ...
        style={{
          backgroundImage: "url('https://php.kodesolution.com/2025/electricien-php/images/background/page-title.jpg')",
        }}
      >
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-3xl mx-auto">
          ...
          >
             <Link to="/"><span className="hover:underline cursor-pointer hover:text-red-500">Home</span></Link>  &gt; Contact Us
          </p>
        </div>
      </section>
